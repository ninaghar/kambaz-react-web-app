...
export default function Assignments() {
  ...
  // Fetch assignments from server using database client
  const fetchAssignments = async () => {
    if (!courseId) return;
    try {
      console.log("Fetching assignments for course:", courseId);
      setLoading(true);
      const courseAssignments = await assignmentsClient.findAssignmentsForCourse(courseId);
      console.log("Found assignments:", courseAssignments);
  ...
  // Create new assignment using database client
  ...
  // Delete assignment using database client
            ...
            {assignments.length === 0 ? (
              <ListGroup.Item className="text-center p-4">
                <div className="text-muted">
                  {loading ? "Loading assignments..." : "No assignments found for this course."}
                  {isFaculty && !loading && (
                    <div className="mt-2">
                      <button 
                    ...
                    <div className="d-flex">
                      ...
                      <div>
                        ...
                        <div className="small text-muted">
                          ...
                          <strong>Not available until</strong> {formatDate(assignment.availableDate || assignment.available)}
                          <br />
                          <strong>Due</strong> {formatDate(assignment.dueDate || assignment.due)} | {assignment.points} pts
                        </div>
